...
function generateMarkov(){    
	var yourSlogan = writeSlogan(parseIt(slogans), markov(parseIt(slogans)));	
    document.getElementById("generator").innerHTML = yourSlogan;	
    
    var campaignName = document.getElementById("lname").value;
    document.getElementById('namedisplay').innerText = campaignName;
}
